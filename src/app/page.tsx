        ...
        <div className="bg-white overflow-hidden w-[1440px] h-[5622px] relative">
                ...
                <div
                  ...
                  className={`absolute top-0 ${
                    index === 0
                      ...
                      ? "left-[269px]"
                      : "left-[409px]"
                  } [font-family:'Gilroy-Medium-Medium',Helvetica] font-medium text-white text-lg tracking-[0] leading-[normal]`}
                >
                  {item.label}
                </div>
              ))}
          ...
          <section className="absolute top-[1203px] left-0 w-full">
            ...
            {features.map((feature, index) => (
              <Card
                key={feature.title}
                className={`absolute w-[284px] top-0 ${feature.position} bg-transparent border-none shadow-none`}
              >
          ...
          <section className="absolute w-[1440px] h-[906px] top-[1504px] left-0 bg-[#f7f7f7]">
            ...
            <Tabs
              defaultValue="chair"
              className="absolute top-[134px] left-[546px]"
            >
              <TabsList className="inline-flex items-start p-1.5 bg-[#eeeeee] rounded-[44px] h-auto">
                <TabsTrigger
                  value="chair"
                  className="flex w-[84px] h-[45px] items-center justify-center gap-2.5 p-1 bg-white rounded-[32px] data-[state=active]:bg-white"
                >
                ...
                <TabsTrigger
                  value="beds"
                  className="flex w-[84px] h-[45px] items-center justify-center gap-2.5 p-1 rounded-[32px]"
                >
              ...
              <TabsContent
                value="chair"
                className="absolute w-[1287px] h-[492px] top-[137px] left-[-470px]"
              >
                <div className="absolute w-[1198px] h-[492px] top-0 left-[45px]">
                  {products.map((product, index) => (
                    <Card
                      key={product.name}
                      className={`absolute w-[268px] h-[492px] top-0 ${
                        index === 0
                          ? "left-0"
                          : index === 1
                          ? "left-[310px]"
                    ...
                    >
                      <CardContent className="relative h-[492px] p-0">
                        ...
                        <div className="absolute top-[303px] left-[21px]">
                          <Badge
                            variant="secondary"
                            className="absolute w-[43px] top-0 left-0 [font-family:'Inter',Helvetica] font-normal text-[#8d8d8d] text-[16.8px] leading-[normal] tracking-[0] bg-transparent border-none p-0 h-auto"
                          >
                            {product.category}
                          </Badge>
                        ...
                        <img
                          className={`absolute top-0 ${
                            index === 0
                              ? "w-[218px] h-[278px] left-6"
                              : index === 1
                              ? "w-[218px] h-[273px] left-6"
                              : index === 2
                              ? "w-[223px] h-[277px] left-[27px]"
                              : "w-[241px] h-[289px] left-[13px]"
                          }`}
                          alt="Group"
                          src={product.image}
                        />
            ...
            <div className="absolute w-[125px] h-[33px] top-[823px] left-[665px]">
              <Button
                variant="link"
                className="p-0 h-auto text-[#e58311] [font-family:'Gilroy-Medium-Medium',Helvetica] font-medium text-lg tracking-[0] leading-[33.3px]"
              >
                View All
              </Button>
              <img
